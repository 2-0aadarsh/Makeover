...
/**
 * Admin Onboarding Welcome Email Template
 * @param {Object} data - { onboardingLink, adminName, creatorName, expiresInHours }
...
<head>
  ...
  <title>Welcome to WeMakeover Admin Portal</title>
  ${baseStyles}
</head>
<body>
  <div class="email-container">
    <div class="header">
      <h1>🎉 Welcome to WeMakeover Admin Portal!</h1>
    ...
    <div class="content">
      ...
      <p style="margin-bottom: 20px; color: #4b5563;">
        You've been invited by <strong>${creatorName}</strong> to join the WeMakeover Admin Portal. 
        We're excited to have you on board! 🚀
      </p>

      <div class="info-section" style="background: #f9fafb; padding: 20px; border-radius: 12px; margin: 25px 0; border-left: 4px solid #CC2B52;">
        ...
        <ol style="margin: 0; padding-left: 20px; color: #4b5563; line-height: 1.8;">
          <li>Click the button below to access your onboarding page</li>
          <li>Set up your secure password</li>
          <li>Start managing the WeMakeover platform!</li>
        </ol>
      </div>

      <div style="text-align: center; margin: 35px 0;">
        <a href="${onboardingLink}" class="button" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #CC2B52 0%, #B02547 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 15px rgba(204, 43, 82, 0.3);">
          Complete Onboarding →
        </a>
      </div>

      <div class="info-section" style="background: #fef3c7; padding: 20px; border-radius: 12px; margin: 25px 0; border-left: 4px solid #f59e0b;">
        <h4 style="margin: 0 0 10px 0; color: #92400e; font-size: 14px;">⏰ Important:</h4>
        <p style="margin: 0; color: #78350f; font-size: 14px; line-height: 1.6;">
          This onboarding link will expire on <strong>${formattedExpiryDate}</strong> (${expiresInHours} hours from now). 
          Please complete your onboarding before the link expires.
        </p>
      </div>

      <div class="info-section" style="background: #eff6ff; padding: 20px; border-radius: 12px; margin: 25px 0; border-left: 4px solid #3b82f6;">
        <h4 style="margin: 0 0 10px 0; color: #1e40af; font-size: 14px;">🔒 Security Note:</h4>
        <p style="margin: 0; color: #1e3a8a; font-size: 14px; line-height: 1.6;">
          For security reasons, this link can only be used once. If you need a new link or have any concerns, 
          please contact the admin who created your account.
        </p>
      </div>
      ...
      <p style="margin: 10px 0 20px 0; word-break: break-all; font-size: 13px; color: #3b82f6; background: #f3f4f6; padding: 12px; border-radius: 6px;">
        ${onboardingLink}
      </p>

      <p style="margin: 20px 0 0 0; font-size: 14px; color: #6b7280;">
        Need help? Contact us at <a href="mailto:${process.env.ADMIN_EMAIL || 'support@wemakeover.com'}" style="color: #CC2B52; text-decoration: none; font-weight: 600;">${process.env.ADMIN_EMAIL || 'support@wemakeover.com'}</a>
      </p>
    </div>
    ...
    <div class="footer">
      ...
      <p style="margin: 10px 0 0 0; font-size: 11px; color: #9ca3af;">
        You're receiving this email because you've been added as an admin to the WeMakeover platform.
      </p>
    </div>
  </div>
</body>
