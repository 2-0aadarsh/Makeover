...
const AddressDetail = ({ currentAddress = "", onAddressUpdate = null }) => {
  ...
  const hasSavedAddresses = Boolean(isAuthenticated && addresses?.length > 0);
    ...
    <>
      ...
      <div className="w-full pb-4 border-b border-gray-200">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 mb-3">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4">
            ...
            >
              {hasSavedAddresses ? "Add another address" : "Add Address"}
            </button>
            {hasSavedAddresses && (
              <button
      ...
      {showAddressForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-hidden overscroll-contain">
          <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto" data-modal-scroll>
            {/* Modal Header */}
      ...
      <AuthPromptModal
        ...
        message="Before managing addresses, please sign in. It only takes a moment, and your cart stays safe."
