...
const AdminPagination = ({ pagination, onPageChange }) => {
  const { currentPage, totalPages, limit, totalBookings, totalCustomers, totalEnquiries, totalReviews, hasNextPage, hasPrevPage } = pagination;
  const totalItems = totalBookings || totalCustomers || totalEnquiries || totalReviews || 0;
