...
const RescheduleBookingModal = ({
  ...
  const isFormValid = () => {
    ...
    const paymentChanged = newPaymentMethod && newPaymentMethod !== booking?.paymentDetails?.paymentMethod;
  ...
  const handleConfirm = () => {
    ...
    if (newPaymentMethod && newPaymentMethod !== booking?.paymentDetails?.paymentMethod) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div>
              ...
              <p className="text-pink-100 mt-1 text-sm">
                {remainingReschedules > 0 
                  ? `You have ${remainingReschedules} reschedule${remainingReschedules > 1 ? 's' : ''} remaining`
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <h3 className="font-semibold text-gray-900 mb-3 flex items-center">
              <svg className="w-5 h-5 mr-2 text-[#CC2B52]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mb-6">
            <h3 className="font-semibold text-gray-900 mb-3 flex items-center">
              ...
              Payment Method <span className="text-gray-400 font-normal text-sm">(Optional)</span>
            </h3>
            <p className="text-xs text-gray-500 mb-3">Current: {currentPaymentMethod === 'online' ? 'Pay Online' : 'Pay After Service'}</p>
          ...
          <div className="mb-6">
            ...
            />
            <p className="text-xs text-gray-500 mt-1">{rescheduleReason.length}/500 characters</p>
          </div>
