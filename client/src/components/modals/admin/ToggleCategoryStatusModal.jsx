...
/**
 * ToggleCategoryStatusModal - Confirmation modal for toggling category active status
 * Matches business design with consistent styling
 */
const ToggleCategoryStatusModal = ({ categoryName, isActive, onConfirm, onCancel }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="toggle-category-status-title"
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-600 mb-6">
          {isActive
            ? "This category will no longer appear on the homepage or in public listings."
            : "This category will appear again on the homepage and in public listings."}
        </p>
...
export default ToggleCategoryStatusModal;
